<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="江苏省每日数据汇总" align="center">
        ...
        <el-table-column :label="title1" align="center">
          ...
          <el-table-column prop="s5" width="70" label="未去江苏" />
          <el-table-column prop="s6" width="70" label="去过或途径江苏" />
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleDownload() {
      ...
      // 设置文件名
      link.download = '江苏省' + this.time + '数据汇总.xls'
      link.click()
