<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="高校名称" prop="school" />
      <el-table-column align="center" label="所在院系" prop="faculty" />
      <el-table-column align="center" label="所在部门" prop="department" />
      ...
      <el-table-column align="center" label="来源省份" prop="fromprovince" />
      <el-table-column align="center" label="来源城市" prop="fromcity" />
      <el-table-column align="center" label="来源区域" prop="fromdistrict" />

      <el-table-column align="center" label="14天内是否去过或经过重点疫区" prop="ifwh" />
      <el-table-column align="center" label="停留时间" prop="whtime" />

      <el-table-column align="center" label="居住类型" prop="livetype" />
      <el-table-column align="center" label="添加时间" prop="addtime" />
      <el-table-column align="center" label="是否接触感染者" prop="iftouch" />
...
<script>
import { listUserSchool } from "@/api/njuser";
