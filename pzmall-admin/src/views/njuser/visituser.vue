<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-input
        v-model="listQuery.visitaddress"
        clearable
        class="filter-item"
        style="width: 150px;"
        placeholder="请输入访问地址"
    ...
    >
      ...
      <el-table-column align="center" label="交通方式" min-width="200px" prop="traffictype" />
      <el-table-column align="center" label="交通信息" min-width="200px" prop="trafficinfo" />

      <el-table-column align="center" label="重点疫区说明" prop="ifwh" />
      <el-table-column align="center" label="是否小区" prop="ifxq" />
      <el-table-column align="center" min-width="120px" label="到访时间" prop="addtime">
        <template slot-scope="scope">{{scope.row.addtime?scope.row.addtime.substring(0,10):""}}</template>
      </el-table-column>

      <el-table-column align="center" label="到访地址" prop="visitaddress" />
      <el-table-column align="center" label="到访体温" prop="temperature" />
      <el-table-column align="center" label="访问地址编码" prop="visitcode" />
...
<script>
import { listUserVisit } from "@/api/njuser";
