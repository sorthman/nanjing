...
public class AdminConfigController {
    ...
    @RequiresPermissions("adminapi:config:mall:list")
    ...
    @RequiresPermissions("adminapi:config:mall:updateConfigs")
    ...
    @RequiresPermissions("adminapi:config:express:list")
    ...
    @RequiresPermissions("adminapi:config:express:updateConfigs")
    ...
    @RequiresPermissions("adminapi:config:order:list")
    ...
    @RequiresPermissions("adminapi:config:order:updateConfigs")
    ...
    @RequiresPermissions("adminapi:config:wx:list")
    ...
    @RequiresPermissions("adminapi:config:wx:updateConfigs")
