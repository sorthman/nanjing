...
public class AdminAdminController {
    ...
    @RequiresPermissions("adminapi:adminapi:list")
...
//        }
    ...
    @RequiresPermissions("adminapi:adminapi:create")
    ...
    @RequiresPermissions("adminapi:adminapi:read")
    ...
    @RequiresPermissions("adminapi:adminapi:delete")
